...
<div className="    w-[1440px] h-[525px] bg-white  mt-[150px]  mx-auto    " >
  ...
  <div className="   w-[1240px] h-[390px]  flex  justify-between pt-20 mx-auto ">
          ...
          <div className="  w-[817px] h-[215px]  ">
            <div className="  ">
                <div className="bg-[#F9F1E7] px-60  font-Poppins font-medium text-base leading-6 w-[817px] h-[55px] text-black  space-x-20">
                  <span >Product</span>
                  <span >Price</span>
                  <span >Quantity</span>
                  <span >Subtotal</span>
          ...
          <div className="bg-[#F9F1E7] p-6 space-y-6  rounded-lg shadow-md w-[393px] h-[390px]">
            ...
            <button className="w-[222px] h-[58.95px]  text-black  py-2 rounded-[15px] border-2 mx-auto border-gray-500 hover:bg-gray-800 hover:text-white  ">
              Check Out
            </button>
          </div>         
